...
export const NavigationItems = ({ itemName, path }: navigationProps) => {
  return (
    <li className="navigation__item">
      <a href="" className={`navigation__link`}>{itemName}</a>
    </li>
  );
};
    ...
    <div className='landingpage__navigation'>
     <ul className='landingpage__navigation--list'>
        <li className='landingpage__navigation--logo'>
            <div className='landingpage__navigation--logo-background'>
      ...
      {LandingpageHeaderItems.map((item, i) => {
        return <NavigationItems key={i} itemName={item.name} path={item.path} />;
      })}
        <li>
            <ul className='landingpage__navigation--auth'>
                <li>Login</li>
                <li className='btn-rounded btn-primary landingpage__navigation--auth-signup'>Signup</li>
            </ul>
        </li>
      </ul>
    </div>
